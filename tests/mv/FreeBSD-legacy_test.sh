...
ckf()
{
	...
	then
		ok
                ...
                echo "Specified file was not correct !"
		notok
	fi
}
...
ckp()
{
	...
	then
		ok
                ...
                echo "Specified file was not a fifo !"
		notok
	fi
}
...
ckd()
{
	...
	then
		ok
                ...
                echo "Specified file was not a directory !"
		notok
	fi
}
...
cknt()
{
	if [ -r $1 ]
	then
                echo "Specified file was not supposed to exist !"
		notok
	else
		ok
	fi
...
ckfail()
{
	...
	then
		ok
                ...
                echo "This was supposed to have failed but succeeded !"
		notok
	fi
}
...
ckok()
{
	...
	then
		ok
                ...
                echo "This was supposed to have succeeded but failed !"
		notok
	fi
}
